...
namespace EcommerceApp.Services
{
    ...
    public class CloudinaryService
    {
        ...
        /// <summary>
        /// Upload an image from a public URL to Cloudinary (used for database seeding).
        /// </summary>
        public async Task<string> UploadFromUrlAsync(string imageUrl, string folder = "ecommerce-seed")
        {
            try
            {
                var uploadParams = new ImageUploadParams
                {
                    File = new FileDescription("seed", imageUrl),
                    Folder = folder,
                    Transformation = new Transformation()
                        .Quality("auto")
                        .FetchFormat("auto")
            ...
            {
                _logger.LogWarning(ex, "Cloudinary URL upload failed for {Url}, using source URL", imageUrl);
                return imageUrl;
            }
        }
